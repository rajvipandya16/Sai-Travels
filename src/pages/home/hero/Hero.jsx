...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <RootLayout className="absolute top-0 left-0 w-full h-full py-[9ch] bd-gradient-to-b from-neutral-50/70 
      via-neutral-50/15 to-neutral-50/5 flex items-center justify-start text-center flex-col gap-9">  

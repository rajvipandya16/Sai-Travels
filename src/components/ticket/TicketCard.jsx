    ...
    <div className='w-full rounded-xl p-5 border-2 border-neutral-300 space-y-5'>
      ...
      {/* bus info, routes */}
                ...
                <div className="space-y-0.5">
                    ...
                    <div className="w-full flex items-center justify-between gap-x-2.5">
                      ...
                      <div className="flex-1 border-dashed border border-neutral-300 relative">
                        <p className="absolute w-14 h-14 p-0.5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <h1 className="text-sm text-neutral-600 font-normal flex items-center justify-center
            gap-x-1.5">
            ...
            <Link to="/bus-tickets/detail" className="w-fit px-1 h-10 bg-primary hover:bg-transparent border-2 border-primary 
